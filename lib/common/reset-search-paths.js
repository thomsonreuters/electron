...
Module._resolveFilename = function (request, parent, isMain) {
  if (request === 'electron') {
    return electronPath
  } else if (request === 'ipc-bus') {
    return path.join(__dirname, 'api', 'ipc-bus.js')
  } else if (request === 'lazy') {
      return path.join(__dirname, '..', '3rdparty', 'lazy', 'lazy.js')
  } else if (request === 'easy-ipc') {
      return path.join(__dirname, '..', '3rdparty', 'easy-ipc', 'lib', 'ipc.js')
  } else {
